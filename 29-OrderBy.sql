SELECT v.Ventas_NroFactura, v.Ventas_CliId, c.Cli_Id, c.Cli_RazonSocial,
...
WHERE v.Ventas_CliId = c.Cli_Id AND v.Ventas_CliId > 1 AND
		vd.VD_VentasId = v.Ventas_Id AND vd.VD_ProdId = p.Prod_Id AND p.Prod_Id AND p.Prod_Id AND p.Prod_ProvId = pr.Prov_Id
